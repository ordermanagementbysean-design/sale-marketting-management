...
import { PANEL_BASE, panelPath } from "@/constants/routes";
import LoginPage from "@/features/auth/pages/LoginPage";
import AdminLayout from "@/shared/layouts/AdminLayout";
import CompanyLandingPage from "@/features/landing/pages/CompanyLandingPage";
    ...
    <BrowserRouter>
      <AuthProvider>
        <Routes>
          ...
          <Route path={panelPath("login")} element={<LoginPage />} />
          <Route
            path={PANEL_BASE}
            element={
              <ProtectedRoute>
